...
_WANDB_PROJECT = flags.DEFINE_string("wandb_project", "hpo", "wandb project")
_WANDB_ENTITY = flags.DEFINE_string("wandb_entity", "ethanluoyc", "wandb user")
...
def main(_):
    with xm_cluster.create_experiment(experiment_title="hpo") as experiment:
        ...
        if not _LAUNCH_ON_CLUSTER.value:
            ...
            logdir = _LOGDIR.value or os.environ.get("LXM_CLUSTER_LOG_DIR", None)
